package org.example.design_patterns.behavioual_patterns.state_design_pattern.design_vending_machine.vending_states.impl;

import org.example.design_patterns.behavioual_patterns.state_design_pattern.design_vending_machine.Coin;
import org.example.design_patterns.behavioual_patterns.state_design_pattern.design_vending_machine.Item;
import org.example.design_patterns.behavioual_patterns.state_design_pattern.design_vending_machine.VendingMachine;
...
public class SelectionState implements State {
    ...
    public void chooseProduct(VendingMachine machine, int codeNumber) throws Exception{
        ...
        for(Coin coin : machine.getCoinList()){
            paidByUser = paidByUser + coin.amount;
        }
